                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="logo text-center">
                            <h1>Mukta Rani Biswas</h1>
                            <span><b>Nothing is Impossible, the word itself says "Iam Possible"
                                !</b></span>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="home-slider">
                            <div id="carousel-example-generic" class="carousel slide" data-ride="carousel" width ="500"style="padding-bottom: 30px;">
